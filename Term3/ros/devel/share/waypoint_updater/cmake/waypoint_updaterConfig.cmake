...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_updater_SOURCE_PREFIX /udacity/CarND-Capstone/ros/src/waypoint_updater)
  set(waypoint_updater_DEVEL_PREFIX /udacity/CarND-Capstone/ros/devel)
  ...
  set(waypoint_updater_INSTALL_PREFIX /udacity/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/udacity/CarND-Capstone/ros/src/waypoint_updater/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
